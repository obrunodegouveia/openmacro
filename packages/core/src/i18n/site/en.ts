...
export const en = {
  ...
  'tflow.startOver': 'Start over',
  'tflow.balanced': 'Balanced',
  'tflow.offBalance': 'Off balance',
  'tflow.assets': 'Assets',
  'tflow.liabilities': 'Liabilities',
  'tflow.assetsHint': 'What it owns',
  'tflow.liabilitiesHint': 'What it owes',
  'tflow.removeA11y': 'Remove {account} from {entity} {side}',
  'tflow.placeA11y': 'Place the selected entry on {entity}’s {side}',
  'tflow.placeHere': 'Place here',
  'tflow.opening': 'Opening {amount}',
  'match.nowDefinition': 'Now pick its definition',
  'match.pickTerm': 'Pick a term, then its definition',
  'match.change': 'Change',
  'order.earliestTop': 'Earliest cause at the top',
  'order.moveEarlier': 'Move “{label}” earlier',
  'order.moveLater': 'Move “{label}” later',
  'sim.done': '— done',
  'sim.notYet': '— not yet',
  'player.min': '{count, number} min',
  'player.xpAvailable': '{count, number} XP available',
  'player.challenges': '{count, plural, one {# challenge} other {# challenges}}',
  'player.xp': '{count, number} XP',
  'map.play': 'Play',
  'map.replay': 'Replay',
  'video.overview': '{title} — overview',
  'snippet.copy': 'Copy',
  'snippet.copied': 'Copied',
  'permalink.copy': 'Copy a link to {label}',
  'permalink.copied': 'Link copied',
  'permalink.copiedLive': 'Link copied to clipboard',
