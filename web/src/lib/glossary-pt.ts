...
export const GLOSSARY_PT: Record<string, TranslatableEntry> = {
  ...
  'quantitative-easing': {
    ...
    aliases: ['compras de activos', 'compras de activos em larga escala', 'APP', 'PEPP'],
    definition:
    ...
    explanation: [
      'Mecanicamente, o QE é uma troca de activos. Quem vende entrega uma obrigação e recebe um depósito; o banco de quem vende recebe reservas. A riqueza líquida de ninguém muda muito — o que muda é a composição daquilo que o sector privado detém.',
      'Como retira duração e tira do mercado colateral de alta qualidade, o QE actua sobretudo através do preço do risco e da forma da curva de rendimentos, e não entregando a alguém dinheiro para gastar.',
    ...
    mechanics: [
      { label: 'Banco central', detail: 'Activo: obrigações a subir. Passivo: reservas a subir no mesmo montante.' },
      { label: 'Banco de quem vende', detail: 'Activo: reservas a subir. Passivo: o depósito de quem vende a subir.' },
  ...
  'quantitative-tightening': {
    ...
    explanation: [
      'A redução é passiva. Quando uma obrigação que o banco central detém vence, o emitente reembolsa e o banco central simplesmente não compra outra. O activo desaparece de um lado do balanço e as reservas desaparecem do outro.',
      'Isso torna o QT mais lento e menos controlável do que o QE. O ritmo é fixado pelo perfil de maturidades daquilo que se detém e por qualquer tecto mensal, não por uma decisão tomada reunião a reunião.',
    ...
    mechanics: [
      { label: 'Banco central', detail: 'Activo: obrigações a descer no vencimento. Passivo: reservas a descer no mesmo montante.' },
  ...
  'deposit-facility-rate': {
    ...
    aliases: ['taxa de depósito do BCE', 'taxa directora do BCE'],
    definition:
    ...
    explanation: [
      ...
      'Entre 2014 e 2022 a DFR foi negativa — os bancos pagavam para estacionar dinheiro no BCE. Foi uma tentativa deliberada de empurrar liquidez para fora da facilidade de depósito e para o crédito, e faz da área do euro a maior experiência de taxas directoras negativas alguma vez feita.',
  ...
  'main-refinancing-operations': {
    ...
    explanation: [
      ...
      'Antes de 2008 a MRO era a torneira principal por onde a liquidez chegava ao sistema, e a taxa da MRO era por isso a taxa directora de referência. A partir do momento em que o excesso de liquidez se tornou abundante, foi a facilidade de depósito que assumiu esse papel.',
    ...
    mechanics: [
      ...
      { label: 'Balanço', detail: 'Activo do Eurosistema: crédito a subir. Passivo: a conta do banco a subir.' },
    ],
    misreading:
      'Que a taxa da MRO ainda é «a» taxa do BCE. Num sistema de piso é a taxa da facilidade de depósito que os mercados usam como referência; a MRO importa sobretudo como tecto do corredor estreitado.',
  },
  ...
  sofr: {
    ...
    mechanics: [
      { label: 'O que mede', detail: 'Financiamento overnight garantido por títulos do Tesouro, ponderado por transacção.' },
  ...
  'euro-short-term-rate': {
    ...
    definition:
      'O índice de referência do BCE para o custo do financiamento overnight sem garantia dos bancos da área do euro, calculado a partir de transacções declaradas do mercado monetário e substituto da EONIA.',
    explanation: [
      ...
      'Transacciona ligeiramente abaixo da taxa da facilidade de depósito em condições normais, porque alguns dos que emprestam na amostra reportada não têm acesso directo às facilidades do BCE e aceitam um pouco menos.',
    ...
    mechanics: [
      ...
      { label: 'Equivalente nos EUA', detail: 'A taxa efectiva dos fundos federais — sem garantia — e não a SOFR.' },
    ],
    misreading:
  ...
  eurodollar: {
    ...
    definition:
      'Um depósito em dólares norte-americanos detido num banco fora da jurisdição dos Estados Unidos — dólares criados no estrangeiro, fora do alcance directo da Reserva Federal.',
    explanation: [
      ...
      'Um banco fora dos EUA consegue criar depósitos em dólares emprestando dólares, exactamente como um banco americano — mas não consegue criar as reservas que em última instância liquidam esses direitos. Quando o financiamento em dólares offshore seca, não há emprestador de último recurso doméstico por trás.',
    ...
    mechanics: [
      ...
      { label: 'O que lhe falta', detail: 'Acesso directo às reservas da Fed, seguro de depósitos, e janela de desconto.' },
      { label: 'Sinal de tensão', detail: 'Swaps de base cambial a mover-se fortemente para território negativo contra o dólar.' },
    ],
    misreading:
      'Que o sistema do dólar está contido dentro dos Estados Unidos. A maior parte do crédito em dólares é criada fora dele, e é por isso que um banco central americano acaba a actuar como o banco central do mundo.',
  },
  ...
  'primary-dealer': {
    ...
    misreading:
      'Que o QE mete dinheiro directamente na economia real. Chega primeiro a um dealer, e se alguma coisa viaja mais longe depende do que quem vendeu fizer a seguir.',
  },
  ...
  'treasury-general-account': {
    ...
    definition:
      'A conta operacional do Tesouro dos EUA na Reserva Federal — a conta à ordem do Estado, e um passivo do banco central que concorre directamente com as reservas bancárias.',
    explanation: [
      ...
      'O inverso acontece quando o Tesouro gasta: a TGA desce e as reservas voltam ao sistema bancário. A despesa pública é, mecanicamente, uma injecção de reservas.',
      'Isto faz da TGA uma das maiores fontes de volatilidade semanal nos saldos de reservas — muitas vezes maior do que tudo o que o banco central esteja a fazer deliberadamente. Os episódios do tecto da dívida, em que o saldo é esgotado e depois reconstruído, movem centenas de milhares de milhões.',
    ],
    mechanics: [
  ...
  'discount-window': {
    ...
    definition:
      'A facilidade permanente da Reserva Federal para emprestar directamente aos bancos contra colateral — a rede de segurança que deveria limitar até onde as taxas de curto prazo podem subir.',
    explanation: [
      'Em teoria nenhum banco deveria pagar mais do que a taxa de desconto para se financiar de um dia para o outro, porque pode sempre pedir à Fed. Na prática o tecto verte, porque pedir traz estigma.',
      'O estigma é o problema central de desenho da janela. Um banco que a use pode ser lido como incapaz de se financiar privadamente, por isso os bancos evitam-na exactamente quando mais precisam dela — o oposto do que uma rede de segurança deveria fazer.',
  ...
  'central-bank-swap-line': {
    ...
    explanation: [
      ...
      'As linhas de swap passaram a acordos permanentes entre seis grandes bancos centrais depois de 2008 e foram alargadas drasticamente em Março de 2020. São a peça menos discutida e mais consequente da arquitectura global de crise.',
    ],
    mechanics: [
  ...
  'money-multiplier': {
    ...
    aliases: ['multiplicador de depósitos', 'multiplicador das reservas fraccionárias'],
    definition:
      'O rácio dos manuais m = 1/R que descreve o máximo de dinheiro em depósitos que um sistema bancário poderia sustentar sobre uma dada base de reservas — um tecto, não uma descrição de como os bancos funcionam de facto.',
    explanation: [
      'O modelo corre uma cadeia: chega um depósito, o banco guarda uma fracção R e empresta o resto, o empréstimo volta a ser depositado, e assim por diante. Somado até ao infinito, uma unidade de moeda de base sustenta 1/R unidades de depósitos.',
  ...
  'legal-tender': {
    ...
    explanation: [
      ...
      'O resto é confiança institucional: um banco central independente, contratos que se fazem cumprir, e uma expectativa plausível de que a unidade ainda significará alguma coisa para o ano. Nenhuma destas coisas é uma cobertura física, e é exactamente por isso que ao arranjo se chama fiduciário.',
    ],
    mechanics: [
