...
export interface Answer {
  /**
   * Stable key for the translation overlay in `answers-pt.ts`.
   *
   * Not derived from the question, because rewording a question for search —
   * which is the whole point of these — would silently drop its translation
   * and put an English answer back on a Portuguese page.
   */
  id: string;
  question: string;
